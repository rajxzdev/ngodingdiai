...
const STATS = [
  { value: 9, suffix: "", label: "Role AI berurutan" },
  { value: 6, suffix: "", label: "Output .md siap pakai" },
  { value: 8, suffix: "+", label: "Provider didukung" },
  { value: 100, suffix: "%", label: "BYOK — key di tanganmu" },
];
  ...
  return (
    <main className="overflow-x-clip">
      ...
      <section className="relative">
        ...
        {/* Aurora ala reactbits */}
        <div className="aurora absolute inset-0">
          <span className="aurora-blob aurora-blob-1 left-[-10%] top-[-20%] h-[420px] w-[420px] bg-indigo-500/20 dark:bg-indigo-500/15" />
          <span className="aurora-blob aurora-blob-2 right-[-8%] top-[10%] h-[380px] w-[380px] bg-violet-500/15 dark:bg-violet-500/10" />
          <span className="aurora-blob aurora-blob-3 bottom-[-30%] left-[30%] h-[360px] w-[360px] bg-sky-500/10 dark:bg-sky-500/10" />
        </div>
        ...
        <div className="mx-auto w-full px-4 sm:px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              <TextScramble text="Pipeline 9 Role AI, satu alur" />
            </h2>
      ...
      <section className="relative py-14 sm:py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              <TextScramble text="Lima dokumen, satu brief" />
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-zinc-500 sm:text-base dark:text-zinc-400">
      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              <TextScramble text="Tiga langkah sederhana" />
            </h2>
          </Reveal>
      ...
      <section className="py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              <TextScramble text="Kendali penuh di tanganmu" />
            </h2>
          </Reveal>
