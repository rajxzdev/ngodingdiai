...
const STATS = [
  { value: "8", label: "Role AI berurutan" },
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "8 role berjalan berurutan dengan animasi pipeline live. Hasil akhir: prompt.md, prd.md, design.md, map.md, review.md — preview, copy, dan download.",
  },
];
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-16 text-center sm:px-6 sm:pt-24">
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white/70 px-4 py-1.5 text-xs font-medium text-zinc-600 shadow-sm backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-zinc-300">
              ...
              BYOK — Bring Your Own Key · 8 Role AI
            </span>
          </Reveal>
          ...
          <Reveal delay={160}>
            <p className="mx-auto mt-6 max-w-2xl text-pretty text-base leading-relaxed text-zinc-500 sm:text-lg dark:text-zinc-400">
              Delapan role AI berjalan berurutan — dari <b className="text-zinc-700 dark:text-zinc-200">Prompt Engineering</b> hingga{" "}
              <b className="text-zinc-700 dark:text-zinc-200">Design Engineering</b> — menghasilkan{" "}
