...
import { buildRoleMessages, runRoleStream, sleep } from "@/lib/engine";
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            8 role AI · output: prompt.md, prd.md, design.md, map.md, review.md
          </p>
        </div>
        <Link
          href="/settings"
            ...
            <div className="mt-5 space-y-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[10px] leading-relaxed text-zinc-400 dark:text-zinc-500">
                  <b>Rantai:</b> 8 role berurutan, hasil role sebelumnya jadi konteks (kualitas terbaik).{" "}
            ...
            <div ref={logRef} className="max-h-56 overflow-y-auto px-5 py-4 font-mono text-[12px] leading-relaxed">
              {logs.length === 0 ? (
                <p className="text-zinc-400 dark:text-zinc-500">
                  # Pipeline siap. Isi brief, pilih mode, lalu tekan "Jalankan Pipeline 8 Role"…
                </p>
              ) : (
                logs.map((l, i) => (
                  <p
